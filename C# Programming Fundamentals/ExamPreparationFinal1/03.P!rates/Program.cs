    ...
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            while (secondCommand != "End")
            {
                ...
                string[] secondComamndArgs = secondCommand.Split("=>", StringSplitOptions.RemoveEmptyEntries);

                string commandType = secondComamndArgs[0];

                if (commandType == "Plunder")
                {
                    string townToPlunder = secondComamndArgs[1];
                    int populationToRemove = int.Parse(secondComamndArgs[2]);
                    int goldToSteal = int.Parse(secondComamndArgs[3]);
                ...
                {
                    string townToProsper = secondComamndArgs[1];
                    int goldToAdd = int.Parse(secondComamndArgs[2]);
