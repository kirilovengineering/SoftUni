...
{
    public class DoublyLinkedList<T> // като зададем с Т може да използваме в класс Програм да създадем нов обект, Т приема всякъкъв дата тайп Инт, Стринг и каквото и да е , 
    {
